...
{
	[Activity(Label = "ZXing YUV Tool", MainLauncher = true, ScreenOrientation = ScreenOrientation.Portrait)] //, ConfigurationChanges=ConfigChanges.Orientation|ConfigChanges.KeyboardHidden)] // ScreenOrientation = ScreenOrientation.Portrait)]
	...
	public class ZxingSurfaceView : SurfaceView, ISurfaceHolderCallback, Android.Hardware.Camera.IPreviewCallback, Android.Hardware.Camera.IAutoFocusCallback
	{
		...
		public YuvImage GetLastYuvImage()
		{
			return lastYuvImage;
		}
		...
		private YuvImage lastYuvImage = null;
